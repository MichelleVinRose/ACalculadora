package reyes.michelle.calculadora
...
class MainActivity : AppCompatActivity() {
    var operacion: Int=0 //0 = nada, 1 = suma, 2 = resta, 3 = multiplicación, 4 = Division
    var numero1: Double= 0.0
    lateinit var tv_num1:TextView
    lateinit var tv_num2:TextView
    private var puntoIngresado = false
    ...
    fun presionarDigito(view: View){
        ...
        when(view.id){
            ...
            R.id.btnPunto -> {
                if (!num2.contains(".")) {
                    // Agregar el punto solo si no está presente en el texto
